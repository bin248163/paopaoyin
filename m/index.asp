<!--#include file="top.asp"-->
		<div class="content">
				...
				<div class="swiper-container">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<a href="tel:13201469777" class="banner1" style="background: url(images/banner1_02.jpg) center 0 no-repeat;"></a>
						</div>
						<div class="swiper-slide">
							<a href="tel:13201469777" class="banner2"></a>
						</div>
						<div class="swiper-slide">
							<a href="tel:13201469777" class="banner3"></a>
						</div>
					</div>
			...
			<div class="con1">
				...
				<a href="contact.asp" class="nav">
					<i class="navi"><img src="images/i10_05.jpg" alt="" /></i>
					<p>联系我们</p>
				</a>
			</div>
			<div class="con1">
				<h1 class="h1">我们能为您提供</h1>
				<h2 class="h2">We can provide you with</h2>
				<h2 class="h2">买的安心 穿的放心</h2>
				<img src="images/sdx_08.jpg" alt="" style="margin-top: 10px;"/>
			</div>		
			<div class="con1">
			    <h1 class="h1">定制展示</h1>
...
合作，竭诚为您服务， 品质一流，坚如磐石！
			...
			<div class="con1">
				<img src="images/shg_25.jpg" alt="" />
			</div>
			<div class="con1">
				<h1 class="h1">客户评价</h1>
				<h2 class="h2">Customer evaluation</h2>
				<h2 class="h2">耐心 舒心 细心</h2>
				<div class="con1n">
						...
						<div class="swiper-slide">
							<div class="zy-w">
								<div class="zy">
								    ...
								    <div class="zy-r"><img src="images/mjs2_03.jpg" alt="" /></div>
								    <div class="clear"></div>
								    <p class="zy4">
								    	非常棒的一次采购，因为logo和尺寸迟迟提供不了，导致交期非常赶，客服MM耐心细致的提供了各种参考，牺牲了自己的休息时间。大家都很满意！
								    </p>
							    </div>
							</div>
						</div>
						<div class="swiper-slide">
							<div class="zy-w">
								<div class="zy">
								    ...
								    <div class="zy-r"><img src="images/mjs3_03.jpg" alt="" /></div>
								    <div class="clear"></div>
								    <p class="zy4">
								    	必须大力赞！质量很好，印刷真的 没让人失望。收到货立刻又加单了。 
								    </p>
							    </div>
							</div>
						</div>
            ...
            <div class="con1">
                ...
                <p class="bot">
			定制热线：<a href="tel:02987361006">13201469777 </a>      定制热线：<a href="tel:02987361006">029-87361006</a> <br />
